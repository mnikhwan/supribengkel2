...
function submitService() {
    ...
    if (selectedServices.length === 0) {
        ...
        toast.innerHTML = `
        <div id="toast-danger servicekosong" class="z-50 fixed bottom-5 left-5 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-red-50 rounded-lg shadow-sm animate-pulse " role="alert">
